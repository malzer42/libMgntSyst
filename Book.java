...
public class Book extends Object{
    ...
    public void setNAvalaible(int n_availables){
        ...
        nAvailables = ((0 < n_availables && n_availables <= getNPossess()) ? n_availables : 0);
    }
    ...
    public Book nPossess(int n_possess){
        ...
        this.nAvailables = n_possess;
        return this;
    }
    
    public Book nAvailables(int n_availables){
        this.nAvailables = n_availables;
        return this;
    }
    
    // Printing method
    public void print(){
        System.out.printf("Book: %s. %s. %d. %d y.o. and more %d %d\n",
                getQuote(), getTitle(), getYear(), getMinReaderAge(), getNPossess(), getNAvailable());
    }
